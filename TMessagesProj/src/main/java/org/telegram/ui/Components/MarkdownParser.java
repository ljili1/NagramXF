...
// import ru.noties.jlatexmath.JLatexMathDrawable; // LaTeX removed
    ...
    public static TLRPC.WebPage fromMarkdown(MessageObject messageObject) {
        ...
        try {
            ...
            */
            ...
            // latexPlugin.configureParser(parserBuilder); // LaTeX removed
    ...
    */
    ...
    public static class BlockVisitor extends AbstractVisitor {
        ...
        public void visit(CustomBlock customBlock) {
            ...
            } else if (customBlock.getClass().getName().equals("io.noties.markwon.ext.latex.JLatexMathBlock")) {
                // LaTeX removed
            } else {
    ...
    public static class RichTextParser extends AbstractVisitor {
        ...
        public void visit(CustomNode customNode) {
            if (customNode instanceof Strikethrough) {
                ...
                append(s);
            } else if (customNode.getClass().getName().equals("io.noties.markwon.ext.latex.JLatexMathNode")) {
                // LaTeX removed
            } else {
        ...
        @Override
        public void visit(CustomBlock customBlock) {
            if (customBlock.getClass().getName().equals("io.noties.markwon.ext.latex.JLatexMathBlock")) {
                // LaTeX removed
            } else {
                super.visit(customBlock);
            }
